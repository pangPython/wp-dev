...
function txt2img_main() {
    ...
    <form id="txt2img_form" action="<?php echo plugin_dir_url(__FILE__) ?>txt2img_generater.php" method="post" target="txt2img_generater">
        <p><input id="txt2img_pid" name="txt2img_pid" type="hidden" value="<?php global $post; echo $post->ID; ?>"></p>
         <p><input id="title" name="title" type="hidden" value="<?php  echo get_the_title($post->ID); ?>"></p>
        <p><input id="txt2img_pdate" name="txt2img_pdate" type="hidden" value="<?php echo the_time( 'Y-m-d H:i l' ); ?>"></p>
    ...
    <script>
        (function() {
            var post_title        = document.getElementById('title'),
                ...
                txt2img_pdate      = document.getElementById('txt2img_pdate'),
            ...
            var prepare = function(e) {
                ...
                post_title.value = post_title.value + "\n\n";
                //txt2img_pdate.value+"\n" +
                txt2img_content.value =  strip_tags(post_content.value);
